...
var MysqlDatabase = /** @class */ (function () {
    ...
    MysqlDatabase.mapTableDefinitionToType = function (tableDefinition, customTypes, options) {
        if (!options)
            throw new Error();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.queryAsync('SELECT column_name, column_type, data_type ' +
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        tableDefinition = {};
                        return [4 /*yield*/, this.queryAsync('SELECT column_name, data_type, is_nullable ' +
                                'FROM information_schema.columns ' +
