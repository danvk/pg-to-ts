...
describe('index', function () {
    ...
    describe('typescriptOfTable', function () {
        it('calls functions with correct params', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        it('merges string results', function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    describe('typescriptOfSchema', function () {
        it('has schema', function () { return __awaiter(_this, void 0, void 0, function () {
            var tsOfSchema;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        it('has tables provided', function () { return __awaiter(_this, void 0, void 0, function () {
            var tsOfSchema;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
